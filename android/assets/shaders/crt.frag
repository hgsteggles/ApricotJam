...
//#define ENABLE_RGB_SHIFT
#define ENABLE_CHROMATIC_ABERRATIONS
#define ENABLE_BARREL_DISTORTION
#define ENABLE_SCAN_DISTORTION
#define ENABLE_TWEAK_CONTRAST
