...
public class ShaderManager {
	...
	public Mesh createScreenQuad() {
		Mesh sq = new Mesh(true, 4, 6, new VertexAttribute(Usage.Position, 3,
	        "a_position"), new VertexAttribute(Usage.ColorUnpacked, 4, "a_color"),
	    ...
	    sq.setVertices(new float[]{vec0.x, vec0.y, 0, 1, 1, 1, 1, 0, 1,
