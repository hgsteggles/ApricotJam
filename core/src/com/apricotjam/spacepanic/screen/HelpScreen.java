...
public class HelpScreen extends BasicScreen {
	...
	static {
		...
		RESOURCE_LINES.add(new ResourceLine(Resource.PIPE_CLEANER, "Pipe Cleaner", "A good astronaut has clean pipes!", "Resources gain is reduced when", "pipe cleaner is empty"));
