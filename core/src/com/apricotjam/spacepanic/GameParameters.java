...
public class GameParameters {
	...
	static {
		...
		RESOURCE_DEPLETION.put(Resource.PIPE_CLEANER, -0.05f);
		RESOURCE_DEPLETION.put(Resource.PLUTONIUM, -0.05f);
	}
	...
	public static final float DEADENDNESS = 0.8f;
	...
	public static final float MIN_VIEWSIZE = 8.0f;
	...
	public static final float[] TIMER_SLOWDOWN = {1f, 0.8f, 0.6f, 0.5f};
