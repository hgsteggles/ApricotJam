...
public class GameParameters {
	...
	static {
		RESOURCE_MAX.put(Resource.OXYGEN, 1.0f);
		RESOURCE_MAX.put(Resource.DEMISTER, 20.0f);
		RESOURCE_MAX.put(Resource.PIPE_CLEANER, 0.5f);
	...
	static {
		RESOURCE_GAIN.put(Resource.OXYGEN, 2.5f);
		RESOURCE_GAIN.put(Resource.DEMISTER, 2.5f);
		RESOURCE_GAIN.put(Resource.PIPE_CLEANER, 2.5f);
		RESOURCE_GAIN.put(Resource.PLUTONIUM, 2.5f);
	}
	...
	public static float DEATH_TIME = 5.0f;
