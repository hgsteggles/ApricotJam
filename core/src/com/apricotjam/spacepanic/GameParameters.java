...
public class GameParameters {
	...
	private static final ObjectMap<Resource, Float> RESOURCE_MAX = new ObjectMap<Resource, Float>();
	static {
	...
	private static final ObjectMap<Resource, Float> RESOURCE_DEPLETION = new ObjectMap<Resource, Float>();
	static {
